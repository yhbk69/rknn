...
使用方法:
    ...
    # ONNX 模型视频检测
    python yolo11_video.py --model_path ../model/yolo11n.onnx --video_path ../003.avi

    # RKNN 模型视频检测（指定目标平台）
    python yolo11_video.py --model_path ../model/yolo11n.rknn --video_path ../003.avi --target rk3588

    # 保存检测结果视频
    python yolo11_video.py --model_path ../model/yolo11n.onnx --video_path ../003.avi --video_save
...
if __name__ == '__main__':
    # 创建命令行参数解析器
    parser = argparse.ArgumentParser(description='YOLO11 视频检测脚本')
    ...
    while True:
        ...
        # 显示结果
        cv2.imshow("YOLO11 Video Detection", img_p)
